        ...
        config: {
            ...
            handler: async (request, reply) => {
                ...
                if (!authorised) {
                    ...
                    const options = [];
                    const users = migrations.users.map(user => {
                    ...
                    try {
                        await Users.native(async (err, collection) => {
                          await bulkUpsert(collection, users, ['email']);
                        });
                        ...
                        await Questions.native(async (err, collection) => {
                            await bulkUpsert(collection, questions, ['_id']);
                        });
